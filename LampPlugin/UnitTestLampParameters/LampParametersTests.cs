...
namespace UnitTestLampParameters
{
    ...
    class LampParametersTests
    {
        ...
        {
            // Setup
            var lamp = new LampParameters.LampParameters { };

            var sourceParameter = new Parameter 
                { NameParameter = "Body Diameter", MaximumValue = 180, MinimumValue = 90, DefaultValue = 150, Value = 100 };
        ...
        public void SocketPlatformDiameter_GoodSocketPlatformDiameter_ReturnsSameSocketPlatformDiameter()
        {
            ...
            var sourceParameter = new Parameter 
                { NameParameter = "Socket Platform Diameter", MaximumValue = 100, MinimumValue = 70, DefaultValue = 100, Value = 80 };
            var expectedParameter = sourceParameter;
        ...
        public void TubeDiameter_GoodTubeDiameter_ReturnsSameTubeDiameter()
        {
            ...
            var sourceParameter = new Parameter
                {NameParameter = "Tube Diameter", MaximumValue = 60, MinimumValue = 30, DefaultValue = 60, Value = 45};
            var expectedParameter = sourceParameter;
        ...
        public void BodyHeight_GoodBodyHeight_ReturnsSameBodyHeight()
        {
            ...
            var sourceParameter = new Parameter 
                { NameParameter = "Body Height", MaximumValue = 100, MinimumValue = 50, DefaultValue = 100, Value = 56 };
            var expectedParameter = sourceParameter;
        ...
        public void SocketPlatformHeight_GoodSocketPlatformHeight_ReturnsSameSocketPlatformHeight()
        {
            ...
            var sourceParameter = new Parameter
                { NameParameter = "SocketPlatform Height", MaximumValue = 6, MinimumValue = 2, DefaultValue = 4, Value = 3.5 };
            var expectedParameter = sourceParameter;
        ...
        public void TubeHeight_GoodTubeHeightReturnsSameTubeHeight()
        {
            ...
            var sourceParameter = new Parameter
                { NameParameter = "Tube Height", MaximumValue = 6, MinimumValue = 2, DefaultValue = 4, Value = 3.5 };
            var expectedParameter = sourceParameter;
        ...
        public void MinValue_GoodLampParameters_MinimumValueEqualValue()
        {
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformDiameterMinValue, actualSocketPlatformDiameterValue);
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformHeightMinValue, actualSocketPlatformHeightValue);
        ...
        public void MaxValue_GoodLampParameters_MaximumValueEqualValue()
        {
            ...
            var expectedSocketPlatformDiameterMaxValue = lamp.SocketPlatformDiameter.MaximumValue;
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformDiameterMaxValue, actualSocketPlatformDiameterValue);
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformHeightMaxValue, actualSocketPlatformHeightValue);
        ...
        public void DefaultValue_GoodLampParameters_DefaultValueEqualValue()
        {
            ...
            var expectedSocketPlatformDiameterDefaultValue = lamp.SocketPlatformDiameter.DefaultValue;
            ...
            var expectedSocketPlatformHeightDefaultValue = lamp.SocketPlatformHeight.DefaultValue;
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformDiameterDefaultValue, actualSocketPlatformDiameterValue);
            ...
            NUnit.Framework.Assert.AreEqual(expectedSocketPlatformHeightDefaultValue, actualSocketPlatformHeightValue);
        ...
        public void DepthHole_GoodLampParameters_ReturnSameDepthHole()
        {
            ...
            var expectedDepthHole = lamp.BodyHeight.Value + lamp.TubeHeight.Value + lamp.SocketPlatformHeight.Value;
